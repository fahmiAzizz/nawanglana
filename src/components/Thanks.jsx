...
const Thanks = () => {
    ...
    const isInView = useInView(thanks, { once: true });
    ...
    return (
        <div className=' max-w-screen-mobile mx-auto'>
            <motion.div
                ...
                className='text-4xl text-center font-customFont font-semibold'>SALSA & RIAN</motion.div>
            <div>
                <motion.div
                    variants={{
                        hidden: { opacity: 0 },
                ...
                <motion.div
                    ...
                    transition={{ duration: 2, delay: 0.50 }}
                    className='text-center'>
                    <p className='px-12 font-customFont3'>Kami merasa sangat bahagia dan terhormat atas kehadiran Anda, yang akan menambah kesan istimewa pada acara kami.</p>
                    <p className='px-12 font-customFont3'>-Terima Kasih-</p>
                </motion.div>
